  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-2">
        <h1 className="text-2xl font-bold tracking-tight text-gray-900">Payroll System</h1>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-8 flex flex-col items-center justify-center text-center shadow-xs min-h-[400px]">
        ...
        <h2 className="text-xl font-bold text-gray-900 mb-2">Payroll System Page</h2>
        <p className="text-sm text-gray-500 max-w-md">
          Process salaries, view payslips, and manage tax configurations.
        </p>
      </div>
    </div>
  );
